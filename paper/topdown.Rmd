...
Dangerous properties are distinctive properties, and the absolute estimates were not appreciably different from each other  ($\beta_{distinctive} = `r format_regression_effects(brms.priors.zero_inf_beta_max.sansInt, "property_typedistinctive")`$, $\beta_{dangerous} = `r format_regression_effects(brms.priors.zero_inf_beta_max.sansInt, "property_typedangerous")`$) 

As a secondary analysis, we were interested as to whether dangerousness properties were also more *projectible*, as hypothesized by @Leslie2008.
